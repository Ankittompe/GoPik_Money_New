...
public class AwaitingDisbursalAdapter  extends RecyclerView.Adapter<AwaitingDisbursalAdapter.ViewHolder> {
    ...
    public AwaitingDisbursalAdapter(Context context, ArrayList<String> id,
                                         ArrayList<String> po_id,
                                         ArrayList<String> date,
                                         ArrayList<String> brand,
                                         ArrayList<String> dealer_id,
    ...
    @NonNull
    @Override
    public AwaitingDisbursalAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.po_details_cardview, parent, false);
        return new AwaitingDisbursalAdapter.ViewHolder(view);


    }

    @Override
    public void onBindViewHolder(@NonNull AwaitingDisbursalAdapter.ViewHolder holder, int position) {
