...
public class PoDetail_Rejected_Dealer_Adapter extends RecyclerView.Adapter<PoDetail_Rejected_Dealer_Adapter.ViewHolder> {
    ...
    public PoDetail_Rejected_Dealer_Adapter
    ...
    @NonNull
    @Override
    public PoDetail_Rejected_Dealer_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.po_details_cardview, parent, false);
        return new PoDetail_Rejected_Dealer_Adapter.ViewHolder(view);


    }

    @Override
    public void onBindViewHolder(@NonNull PoDetail_Rejected_Dealer_Adapter.ViewHolder holder, int position) {
