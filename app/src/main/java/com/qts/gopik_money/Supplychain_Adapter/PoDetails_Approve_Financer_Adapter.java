...
public class PoDetails_Approve_Financer_Adapter extends RecyclerView.Adapter<PoDetails_Approve_Financer_Adapter.ViewHolder> {
    Context context;
    ...
    public PoDetails_Approve_Financer_Adapter(Context context, ArrayList<String> id,
    ...
    @NonNull
    @Override
    public PoDetails_Approve_Financer_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.po_details_cardview, parent, false);
        return new PoDetails_Approve_Financer_Adapter.ViewHolder(view);
