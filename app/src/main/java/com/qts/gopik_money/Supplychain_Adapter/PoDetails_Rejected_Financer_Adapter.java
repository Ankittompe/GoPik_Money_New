...
public class PoDetails_Rejected_Financer_Adapter extends RecyclerView.Adapter<PoDetails_Rejected_Financer_Adapter.ViewHolder> {
    ...
    public PoDetails_Rejected_Financer_Adapter(Context context, ArrayList<String> id,
    ...
    @NonNull
    @Override
    public PoDetails_Rejected_Financer_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.po_details_cardview, parent, false);
        return new PoDetails_Rejected_Financer_Adapter.ViewHolder(view);


    }

    @Override
    public void onBindViewHolder(@NonNull PoDetails_Rejected_Financer_Adapter.ViewHolder holder, int position) {
