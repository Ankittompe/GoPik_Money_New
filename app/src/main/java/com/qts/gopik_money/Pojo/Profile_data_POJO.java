...
public class Profile_data_POJO {
    ...
    private String tractr_nm;
    private String tractr_ln_dcltn;


    public Profile_data_POJO(String cust_code, String cust_sal,String cust_first_name, String cust_last_name,String cust_email,
                             String cust_mobile
            ,String cust_marital, String cust_qual,String cust_accomodation_type, String cust_add_type_check,String cust_add_time,
                             String cust_org_type,
                             String cust_off_add, String cust_off_pin
            ,String cust_wrk_exp, String timestamp,String cust_emp_type, String cust_cmpny_name,String cust_gross_incm,
                             String cust_industry_type,String cust_bstrdt, String cust_bexp
            ,String cust_bttl_trn, String cust_anl_incm,String curent_address,String permanent_address
            ,String tractr_nm,String tractr_ln_dcltn) {
        ...
        this.tractr_nm = tractr_nm;
        this.tractr_ln_dcltn = tractr_ln_dcltn;
