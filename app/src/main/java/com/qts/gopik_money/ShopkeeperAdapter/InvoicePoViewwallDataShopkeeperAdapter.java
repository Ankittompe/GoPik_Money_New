...
public class InvoicePoViewwallDataShopkeeperAdapter extends RecyclerView.Adapter<InvoicePoViewwallDataShopkeeperAdapter.ViewHolder> {
    ...
    public InvoicePoViewwallDataShopkeeperAdapter(ArrayList<Shopkeeper_PO_profile> mWAppStatusList, Boolean mIsTopFiveList) {
        this.mArraylist = mWAppStatusList;
        this.mIsTopFiveList = mIsTopFiveList;
    }

    @Override
    public InvoicePoViewwallDataShopkeeperAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem = layoutInflater.inflate(R.layout.shopkeeper_viewall_ui, parent, false);
        mContext = parent.getContext();
        return new InvoicePoViewwallDataShopkeeperAdapter.ViewHolder(listItem);
    }

    @Override
    public void onBindViewHolder(InvoicePoViewwallDataShopkeeperAdapter.ViewHolder holder, int position) {
