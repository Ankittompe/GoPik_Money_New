...
public class Goat_Success_Dealer extends AppCompatActivity {
    TextView myridee;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.goat_activity_success__dealer);
        ...
        myridee.setOnClickListener(view -> {
            Intent it = new Intent(Goat_Success_Dealer.this, MainActivity.class);
            startActivity(it);
        });
        backarrow = (ImageView) findViewById(R.id.arrow);
        hometoolbar = (ImageView) findViewById(R.id.hometoolbar);
        backarrow.setOnClickListener(v -> {
            Intent it = new Intent(Goat_Success_Dealer.this, Goat_Customer_Details_Verification_Dealer.class);
            startActivity(it);
