...
public class HeroWallet_DetailsActivity extends AppCompatActivity implements PaymentResultWithDataListener {
    String paymentId;
    String signature;
    String orderId;
    String finalprice1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hero_wallet_details);
        ...
        procced.setOnClickListener(view -> {
            Intent i = new Intent(HeroWallet_DetailsActivity.this, HeroCustomerAcceptancePolicy_DEALER_Activity.class);
            startActivity(i);
        });
        backarrow.setOnClickListener(v -> {
            Intent it = new Intent(HeroWallet_DetailsActivity.this, Goat_Emi_Calculator.class);
            startActivity(it);

        });
        hometoolbar.setOnClickListener(v -> {
            Intent it = new Intent(HeroWallet_DetailsActivity.this, MainActivity.class);
    ...
    private void valid() {
        if (SharedPref.getStringFromSharedPref(AppConstants.BALANCE, getApplicationContext()).equals("NA")) {
            ...
            int mBalance = Integer.parseInt(SharedPref.getStringFromSharedPref(AppConstants.BALANCE, getApplicationContext()));
            if (mBalance < 100) {
                currentbalance.setText("₹ 0");
                procced.setVisibility(View.GONE);
                linear.setVisibility(View.VISIBLE);
            ...
            restApis.createNewOrderID(data).enqueue(new Callback<RazorpayOrderResponse>() {
                ...
                public void onResponse(Call<RazorpayOrderResponse> call, Response<RazorpayOrderResponse> response) {
                    ...
                    try {
                        ...
                        checkout.open(HeroWallet_DetailsActivity.this, options);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
    ...
    public void onPaymentSuccess(String s, PaymentData paymentData) {
        ...
        Toast.makeText(HeroWallet_DetailsActivity.this, "Payment done successfully", Toast.LENGTH_SHORT).show();
    ...
    public void onPaymentError(int i, String s, PaymentData paymentData) {
        ...
        signature = paymentData.getSignature();
        orderId = paymentData.getOrderId();
        Toast.makeText(HeroWallet_DetailsActivity.this, "Payment Failed", Toast.LENGTH_SHORT).show();
        finish();
    ...
    private void update_wallet_credit() {
        ...
        call.enqueue(new Callback<Update_wallet_credit_MODEL>() {
            ...
            public void onFailure(Call<Update_wallet_credit_MODEL> call, Throwable t) {
                Toast.makeText(HeroWallet_DetailsActivity.this, networkError, Toast.LENGTH_SHORT).show();
            }
    ...
    private void get_wallet_details() {
        custPrograssbar.prograssCreate(HeroWallet_DetailsActivity.this);
