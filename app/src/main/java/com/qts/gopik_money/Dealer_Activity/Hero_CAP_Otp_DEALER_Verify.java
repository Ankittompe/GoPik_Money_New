...
public class Hero_CAP_Otp_DEALER_Verify extends AppCompatActivity implements TextWatcher {
    TextView confirm;
    TextView resendotp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hero_activity_c_a_p__otp__d_e_a_l_e_r__verify);
        ...
        backarrow.setOnClickListener(v -> {
            Intent it = new Intent(Hero_CAP_Otp_DEALER_Verify.this, HeroCustomerAcceptancePolicy_DEALER_Activity.class);
            startActivity(it);

        });
        hometoolbar.setOnClickListener(v -> {
            Intent it = new Intent(Hero_CAP_Otp_DEALER_Verify.this, MainActivity.class);
    ...
    private void Resend_otp_to_user() {
        custPrograssbar.prograssCreate(Hero_CAP_Otp_DEALER_Verify.this);
        ...
        call.enqueue(new Callback<Resend_otp_to_user_MODEL>() {
            ...
            public void onResponse(Call<Resend_otp_to_user_MODEL> call, Response<Resend_otp_to_user_MODEL> response) {
                ...
                if (response.body() != null&&response.body().getCode() == 200) {
                        ...
                        Intent i = new Intent(Hero_CAP_Otp_DEALER_Verify.this, Hero_CAP_Otp_DEALER_Verify.class);
                        startActivity(i);
                }
    ...
    private void verify_mobile_number() {
        ...
        Verify_mobile_number_POJO pojo = new Verify_mobile_number_POJO(SharedPref.getStringFromSharedPref(AppConstants.USER_CODE, getApplicationContext()),
                ...
                otptext);
        RestApis restApis = NetworkHandler.getRetrofit().create(RestApis.class);
        Call<Verify_mobile_number_MODEL> call;
        call = restApis.goat_verify_mobile_number(pojo);
            ...
            public void onResponse(Call<Verify_mobile_number_MODEL> call, Response<Verify_mobile_number_MODEL> response) {
                ...
                if (response.body() != null&&response.body().getCode().equalsIgnoreCase("200")) {
                        ...
                        if (SharedPref.getStringFromSharedPref(AppConstants.SEND_OTP_USER_OTP, getApplicationContext()).equals(otptext)) {
                            Intent it = new Intent(Hero_CAP_Otp_DEALER_Verify.this, Aadhar_Activity.class);
                            startActivity(it);
                        } else {
                            custPrograssbar.closePrograssBar();
                        }
