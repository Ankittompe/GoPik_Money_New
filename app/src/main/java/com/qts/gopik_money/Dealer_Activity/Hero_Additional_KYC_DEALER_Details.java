...
public class Hero_Additional_KYC_DEALER_Details extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hero_activity_additional__k_y_c__d_e_a_l_e_r__details);
        ...
        backarrow.setOnClickListener(v -> {
            Intent it = new Intent(Hero_Additional_KYC_DEALER_Details.this, GOAT_KYC_ImageCapture.class);
            startActivity(it);

        });
        hometoolbar.setOnClickListener(v -> {
            Intent it = new Intent(Hero_Additional_KYC_DEALER_Details.this, MainActivity.class);
    ...
    private void profile_data() {
        custPrograssbar.prograssCreate(Hero_Additional_KYC_DEALER_Details.this);
            ...
            public void onResponse(Call<Profile_data_MODEL> call, Response<Profile_data_MODEL> response) {
                if (response.body() != null) {
                    ...
                    if (response.body().getCode().equals("200")) {
                        Intent it = new Intent(Hero_Additional_KYC_DEALER_Details.this, Hero_Customer_Details_Verification_Dealer.class);
                        startActivity(it);
