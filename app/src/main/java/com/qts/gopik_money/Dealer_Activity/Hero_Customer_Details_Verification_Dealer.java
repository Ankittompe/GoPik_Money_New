...
import com.qts.gopik_money.Model.Submit_customer_application_MODEL;
import com.qts.gopik_money.Model.Submit_loan_application_MODEL;
import com.qts.gopik_money.Pojo.Fetch_customer_data_POJO;
import com.qts.gopik_money.Pojo.Submit_customer_application_POJO;
...
public class Hero_Customer_Details_Verification_Dealer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hero_activity_customer__details__d_e_a_l_e_r__verification);
        ...
        fetch_customer_data();
        btsend.setOnClickListener(view -> submit_customer_application());
        backarrow = (ImageView) findViewById(R.id.arrow);
        hometoolbar = (ImageView) findViewById(R.id.hometoolbar);
        backarrow.setOnClickListener(v -> {
            Intent it = new Intent(Hero_Customer_Details_Verification_Dealer.this, Hero_Additional_KYC_DEALER_Details.class);
            startActivity(it);
        });
        hometoolbar.setOnClickListener(v -> {
            Intent it = new Intent(Hero_Customer_Details_Verification_Dealer.this, MainActivity.class);
    ...
    private void fetch_customer_data() {
        custPrograssbar.prograssCreate(Hero_Customer_Details_Verification_Dealer.this);
        ...
        call.enqueue(new Callback<Submit_customer_application_MODEL>() {
            ...
            public void onResponse(Call<Submit_customer_application_MODEL> call, Response<Submit_customer_application_MODEL> response) {
                if (response.body() != null&&response.body().getCode()==200) {
                        custPrograssbar.closePrograssBar();
                        Intent it=new Intent(Hero_Customer_Details_Verification_Dealer.this,Goat_Success_Dealer.class);
                        startActivity(it);
                }
            }
