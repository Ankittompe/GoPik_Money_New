...
import com.qts.gopik_money.Supplychain_Adapter.AwaitingDisbursalAdapter;
...
public class AwaitingDisbursal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        invoiceName.append(TextViewUtils.getColoredString("Invoice of ", ContextCompat.getColor(AwaitingDisbursal.this, R.color.black)));
        invoiceName.append(TextViewUtils.getColoredString(SharedPref.getStringFromSharedPref(AppConstants.DEALER_NAME, getApplicationContext()),
                ContextCompat.getColor(AwaitingDisbursal.this, R.color.blue)));
        ...
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new InvoiceViewDownloadDialog().InvoiceDialog(image, AwaitingDisbursal.this);
            }
        });
...
//                                    et_total_qty.setText(String.valueOf(tempmod));
                        ...
                        Toast.makeText(AwaitingDisbursal.this, networkError, Toast.LENGTH_LONG).show();
                    }
                } else {
                    custPrograssbar.closePrograssBar();
                }
