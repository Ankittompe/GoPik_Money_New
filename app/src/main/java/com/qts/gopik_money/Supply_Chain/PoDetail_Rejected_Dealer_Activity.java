...
public class PoDetail_Rejected_Dealer_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PODealerName.append(TextViewUtils.getColoredString("Purchase order of ", ContextCompat.getColor(PoDetail_Rejected_Dealer_Activity.this, R.color.black)));
        PODealerName.append(TextViewUtils.getColoredString(SharedPref.getStringFromSharedPref(AppConstants.DEALER_NAME, getApplicationContext()),
                ContextCompat.getColor(PoDetail_Rejected_Dealer_Activity.this, R.color.blue)));
            ...
            public void onResponse(Call<Po_all_details_MODEL> call, Response<Po_all_details_MODEL> response) {
                if (response.body() != null) {
                    ...
                    if (response.body().getCode().equals("200")) {
                        ...
                        Toast.makeText(PoDetail_Rejected_Dealer_Activity.this, networkError, Toast.LENGTH_LONG).show();
                    }
