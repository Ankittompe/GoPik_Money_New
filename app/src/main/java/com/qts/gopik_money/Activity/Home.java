...
import com.qts.gopik_money.Fragment.Contest;
import com.qts.gopik_money.Fragment.Broker_QR_Code_Fragment;
import com.qts.gopik_money.Fragment.HomeFragment;
import com.qts.gopik_money.Fragment.Notification;
import com.qts.gopik_money.Fragment.Profile;
import com.qts.gopik_money.Fragment.Reward;
import com.qts.gopik_money.Fragment.Tab_Fragment;
                    ...
                    default:
                        new AlertDialog.Builder(Home.this).setIcon(android.R.drawable.ic_dialog_alert).setTitle("Log Out")
                                ...
                                .setPositiveButton("yes", (dialog, which) -> {
                                    Intent it1 = new Intent(Home.this, LogIn.class);
                                    startActivity(it1);
                                    dealer_logout();
