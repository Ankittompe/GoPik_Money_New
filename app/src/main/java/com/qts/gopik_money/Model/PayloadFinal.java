...
public class PayloadFinal {
    ...
    @SerializedName("applictn_code")
    String applictn_code;
    @SerializedName("dlr_code")
    String dlr_code;

    public String getApplictn_code() {
        return applictn_code;
    }

    public void setApplictn_code(String applictn_code) {
        this.applictn_code = applictn_code;
    }
