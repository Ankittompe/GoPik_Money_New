...
public class PoDetails_Pending_OEM_Adapter extends RecyclerView.Adapter<PoDetails_Pending_OEM_Adapter.ViewHolder> {
    ...
    public PoDetails_Pending_OEM_Adapter(Context context, ArrayList<String> id,
    ...
    @NonNull
    @Override
    public PoDetails_Pending_OEM_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.po_details_cardview, parent, false);
        return new PoDetails_Pending_OEM_Adapter.ViewHolder(view);
