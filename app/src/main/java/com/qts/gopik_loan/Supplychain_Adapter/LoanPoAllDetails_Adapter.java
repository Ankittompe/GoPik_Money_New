...
public class LoanPoAllDetails_Adapter  extends RecyclerView.Adapter<LoanPoAllDetails_Adapter.ViewHolder> {
    ...
    public LoanPoAllDetails_Adapter
    ...
    @NonNull
    @Override
    public LoanPoAllDetails_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.po_details_cardview, parent, false);
        return new LoanPoAllDetails_Adapter.ViewHolder(view);


    }

    @Override
    public void onBindViewHolder(@NonNull LoanPoAllDetails_Adapter.ViewHolder holder, int position) {
