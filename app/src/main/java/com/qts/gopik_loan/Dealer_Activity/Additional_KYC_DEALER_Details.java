...
public class Additional_KYC_DEALER_Details extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Spinner spinner_salution, spinner_customername, spinner_maritialstatus, spinner_qualification,
            spinner_accomodationtype, spinner_sameaddress,
            spinner_organisationtype, spinner_industrtype, spinner_employmenttype, choose_tractor, choose_tractorfinance;
    ...
    String[] sameaddress = {"Select Option", "Yes", "No"};
    String[] organisation = {"Select Option", "PROPRIETORSHIP", "PARTNERSHIP", "CLOSELY HELD - PUBLIC LIMITED", "LISTED- PUBLIC LIMITED", "PRIVATE LIMITED",
            "ASSOCIATION OF PEOPLE", "SUBSIDIARY", "MNC", "SOCIETY", "HUF", "TRUST", "GOVT(ONLY FOR SALARIED)", "PVT LTD_SALARIED"};
    String[] industrytype = {"Select Option", "AGRI OR AGRI ALLIED", "AGRICULTURE", "ARTISAN", "AUTOMOTIVE", "CEMENT AND CEMENT PRODUCTS",
            "CHEMICALS", "COAL"};
    String[] employementtype = {"Select Option", "SALARIED", "SELF EMPLOYED"};
    String[] choosetractor = {"Select Option", "Yes", "No"};
    String[] choosetractorfinance = {"Select Option", "Yes", "No"};
    String sep;
    LinearLayout salaried, self_employed, officelayout, finance, linearspinnertractor, linearspinnertractorfinance;
    String TAG = "finalbikepayment";
    TextView save, mobilenoedittext, tractortype, tractorfinance;
    EditText grossmonthlyincomeedittext, numberinyearsedittext, fullofficeaddressedittext, companynameedittext,
            annualincomeedittext, totalamountturoveredittext, expbussinessedittext, noofyearedittext, permamentadressedittext,
            currentaddressedittext, emailideditext, pincodeeditttext, officefulladdressedittext1, permamentadresspincodeedittext,
            currentaddresspincodeedittext;
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Log.e("vndfjfk", "hvfueisghi" + employementtype[index8]);
      ...
      /*  sep = SharedPref.getStringFromSharedPref(AppConstants.CUSTOMERNAMETYPE, getApplicationContext());
        ...
        if ((SharedPref.getStringFromSharedPref(AppConstants.TRACTOR, getApplicationContext())).equals("Yes")) {
            Log.e("vndfjfk", "hfhf" + SharedPref.getStringFromSharedPref(AppConstants.TRACTOR, getApplicationContext()));
            Log.e("vndfjfk", "hvfuiujkueisghi" + SharedPref.getStringFromSharedPref(AppConstants.TRACTORFINANCE, getApplicationContext()));
        ...
        if ((SharedPref.getStringFromSharedPref(AppConstants.TRACTOR, getApplicationContext())).equals("No")) {
            Log.e("vndfjfk", "yuy" + SharedPref.getStringFromSharedPref(AppConstants.TRACTOR, getApplicationContext()));
            Log.e("vndfjfk", "hvkuifueisghi" + SharedPref.getStringFromSharedPref(AppConstants.TRACTORFINANCE, getApplicationContext()));
            SharedPref.saveStringInSharedPref(AppConstants.TRACTORFINANCE,"No", getApplicationContext());
            Log.e("vndfjfk", "hvooofueisghi" + SharedPref.getStringFromSharedPref(AppConstants.TRACTORFINANCE, getApplicationContext()));
