...
public class Emi_Calculator extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    TextView months,down_payment_2, loan_amount_2, processing_fees,
            gopik_protect_insurance, upfront_payment_by_customer, emi, interst_per_annum;
    Spinner spino;
    EditText down_payment,couponcode,subsidy;
    LinearLayout linearlayout_aftercalculation;
    TextView calculate,apply,customer_price,applycoupon;
 ...
 couponcode.setText(SharedPref.getStringFromSharedPref(AppConstants.LOANPRO_PAYMENT,getApplicationContext()));
    ...
    private void calculation_data() {
        ...
        Calculation_data_POJO pojo = new Calculation_data_POJO(SharedPref.getStringFromSharedPref(AppConstants.BRAND,getApplicationContext()),
                ...
                ,"NA", SharedPref.getStringFromSharedPref(AppConstants.PROD_BRAND,getApplicationContext()),"1","20");
            ...
            public void onResponse(Call<Loan_calculation_Model> call, Response<Loan_calculation_Model> response) {
                ...
                if (response.body() != null) {
                    ...
                    if(response.body().getCode().equals("200")) {
                        ...
                        Log.e("bnjdkshfgdrg","dgbfdhbgu"+response.body().getPayload().getProduct_model());
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Log.e("hfyuguib","hgyuguhnoi"+SharedPref.getStringFromSharedPref(AppConstants.GET_SPINNER_POSITION,getApplicationContext()) );
    }
