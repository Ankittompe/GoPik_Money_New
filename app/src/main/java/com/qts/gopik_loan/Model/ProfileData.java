...
public class ProfileData {
    ...
    public String getBroker_brand() {
        return broker_brand;
    }

    public void setBroker_brand(String broker_brand) {
        this.broker_brand = broker_brand;
    }

    @Expose
    @SerializedName("broker_brand")
    private String broker_brand;
